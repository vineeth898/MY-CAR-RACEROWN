...
display(){
    ...
    /*if(state==='shop'){
        this.pay1.mousePressed(()=>{
            switch(this.acount){
                case 1: if(a1.state!='owned'){money=money-a1.cost;a1.state='owned';a1.cost='owned';}this.pay1.hide();break;
                case 2: if(a2.state!='owned'){money=money-a2.cost;a2.state='owned';a2.cost='owned';}this.pay1.show();this.equip1.hide();break;
                case 3: if(a3.state!='owned'){money=money-a3.cost;a3.state='owned';a3.cost='owned';}break;
            } 
        });*/
    switch(this.acount){
        case 1: text(a1.cost,950,200);text(a1.aero,960,230);image(this.tp1,910,145,110,35);image(this.tp1,150,580,550,175);if(this.t!=null){image(this.t,230,665,100,100);image(this.t,560,670,100,100);}this.ac=a1.cost;break;
        case 2: text(a2.cost,950,200);text(a2.aero,960,230);image(this.tp2,910,145,110,30);image(this.tp2,150,580,600,30*5);if(this.t!=null){image(this.t,220,645,100,100);image(this.t,580,650,100,100);}this.ac=a2.cost;break;
        case 3: text(a3.cost,950,200);text(a3.aero,960,230);image(this.tp3,910,145,110,25);image(this.tp3,150,580,550,125);if(this.t!=null){image(this.t,230,635,80,80);image(this.t,545,640,80,80);}this.ac=a3.cost;break;
    }
}
